      ...
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        ...
        <main className="flex flex-col   justify-center relative bottom-14 px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6 ">
          <form onSubmit={submitHandle}>
            ...
            <h1 className="mt-6 text-2xl font-bold sm:text-3xl md:text-4xl">Register to your E-wallet</h1>

            <p className="mt-4 leading-relaxed">A secure cloud based platform for storage, sharing and verification of documents & certificates.</p>
            <div className="max-w-xl lg:max-w-3xl flex flex-col items-center justify-center">
              <div className="card bg-base-300 mt-8 w-10/12 relative overflow-hidden rounded-lg    sm:p-6 lg:p-6   shadow-xl">
                <span className="absolute inset-x-0 bottom-0 h-2 bg-gradient-to-r from-[#641ae6]  to-[#f87272]"></span>

                <div className="grid md:grid-cols-2 md:gap-3">
                  <div className="hidden sm:block sm:shrink-0 absolute top-7 right-3">
                    <img alt="image" src={userData.photo} className="w-[4.75rem] rounded-md object-cover shadow-sm" />
                  </div>
                  <div className="relative z-0 w-full mb-3 group">
                    ...
                    <label
                      htmlFor="Name"
                      className="text-secondary peer-focus:font-medium absolute text-sm  duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                    >
                      Name
                    </label>
                  </div>
