...
const Register = () => {
  // const handlerRegisterViaDigilocker = () => {
  ...
  //           header: [
  //             {
  //               "x-client-id": "vishwakarma-dg-sbx",
  //             },
  //             {
  //               "x-client-secret": "2UkRN0x71Evm6LU69BfM07GcDgPE5l5c",
  //             },
  //             {
  //               "x-product-instance-id": "9738d915-f184-41c6-9651-2c23d212e272",
  //             },
  //           ],
  //         },
  //         body: {
          ...
          <div className="max-w-xl lg:max-w-3xl">
            ...
            <form action="#" className="mt-8 grid grid-cols-6 gap-6">
              ...
              <div className="col-span-4 flex items-center flex-row justify-start">
                ...
                <a
                  href="https://dg-sandbox.setu.co/digilocker/login/0d98dcb8-f033-4ec5-9b29-c234fb417a41?path=Lzk3MzhkOTE1LWYxODQtNDFjNi05NjUxLTJjMjNkMjEyZTI3Mi8="
